...
class AbstractStepPreset(ABC):
    def __init__(
        ...
        self.spec_class: Type[BaseModel] = BaseModel

    @abstractmethod
    def execute(self, spec: BaseModel) -> LLMResponse:
        pass

    def get_spec_class(self) -> Type[BaseModel]:
        return self.spec_class

    def setLLM(self, llm: ChatOllama):
        self.llm = llm

    def setQuery(self, query: str):
        self.query = query

    def setVectorStore(self, vectorstore: VectorStore):
